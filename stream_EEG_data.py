...
class ReadEEG:
    def __init__(self,
                 data_dir=r'/home/pi/Desktop/dataset-ssvep-exoskeleton-master'):
        ...
        self.subj_list = [name for name in self.dir_list if 'subject' in name]
    ...
    def __train_predefined_classifier(self, epochs, RG_Pipeline_Num=0, estimator='lwf',
        ...
        if RG_Pipeline_Num == 1:
            ...
            clf = make_pipeline(XdawnCovariances(estimator=estimator,
                                                 xdawn_estimator=estimator),
                                TangentSpace(),
                                LogisticRegression(l1, class_weight=None, solver='saga',
